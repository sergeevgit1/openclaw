...
export function renderApp(state: AppViewState) {
  ...
  const chatDisabledReason = state.connected ? null : "Отключено от шлюза.";
      ...
      <header class="topbar">
        <div class="topbar-left">
          <button
            ...
            title="${state.settings.navCollapsed ? "Развернуть боковую панель" : "Свернуть боковую панель"}"
            aria-label="${state.settings.navCollapsed ? "Развернуть боковую панель" : "Свернуть боковую панель"}"
          >
      ...
      <aside class="nav ${state.settings.navCollapsed ? "nav--collapsed" : ""}">
        ...
        <div class="nav-group nav-group--links">
          <div class="nav-label nav-label--static">
            <span class="nav-label__text">Ресурсы</span>
          </div>
          <div class="nav-group__items">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              title="Документация (откроется в новой вкладке)"
            >
